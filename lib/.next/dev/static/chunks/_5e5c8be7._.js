...
function FamiliesPage() {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FamiliesPage.useMemo[supabase]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabaseClient"])()
    }["FamiliesPage.useMemo[supabase]"], []);
    ...
    const callbackUrl = ("TURBOPACK compile-time truthy", 1) ? `${window.location.origin}/auth/callback` : "TURBOPACK unreachable";
    ...
    async function handleEmailAuth() {
        ...
        try {
            ...
            if (mode === "signup") {
                ...
                setMsg("Account created. Please check your email to confirm your address, then return to log in.");
            } else {
...
_s(FamiliesPage, "OuOF8tmRxeK7KwVHnQiLwgb/M7g=", false, function() {
    return [
...
//# sourceMappingURL=_5e5c8be7._.js.map